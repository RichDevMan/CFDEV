...
export const useTicketStore = defineStore('ticket', () => {
  ...
  const queryTicket = async () => {
    try {
      const res: any = await $API(`/player/ticket/query`, {
        method: 'POST',
        headers: {
  ...
  const createTicket = async (params: any) => {
    try {
      const res: any = await $API(`/player/ticket`, {
        method: 'POST',
  ...
  const read = async (params: any) => {
    try {
      const res: any = await $API(`/player/ticket/read`, {
        method: 'PATCH',
        body: JSON.stringify(params),
        headers: {
          'Content-Type': 'application/json',
  ...
  const reply = async (params: any) => {
    try {
      const res: any = await $API(`/player/ticket/reply`, {
        method: 'POST',
        body: JSON.stringify(params),
        headers: {
          'Content-Type': 'application/json',
