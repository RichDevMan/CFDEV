...
export const usePlayerStore = defineStore('player', () => {
  ...
  const fetchInfo = async () => {
    try {
      const res: any = await $API(`/player/info`, {
        method: 'GET',
        headers: {
  ...
  const updatePassword = async (params: any) => {
    try {
      const res: any = await $API(`/player/password`, {
        method: 'PUT',
        body: JSON.stringify(params),
        headers: {
          'Content-Type': 'application/json',
  ...
  const updateTrasactionPassword = async (params: any) => {
    try {
      const res: any = await $API(`/player/password/transaction`, {
        method: 'PUT',
        body: JSON.stringify(params),
        headers: {
          'Content-Type': 'application/json',
  ...
  const bankApply = async (params: any) => {
    try {
      ...
      const res: any = await $API(`/player/bankapply`, {
        method: 'POST',
        body: JSON.stringify(params),
        headers: {
          'Content-Type': 'application/json',
  ...
  const getListenkey = async () => {
    try {
      const res: any = await $API(`/player/token/listenkey`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: getAccessToken()
